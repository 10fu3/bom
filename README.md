...
Additional notices:
- PostgreSQL parser sources `internal/parser/postgres/ddl.y` and `internal/parser/postgres/ddl_gen.go` are under the PostgreSQL license.
- SQLite parser sources `internal/parser/sqlite/ddl.y`, `internal/parser/sqlite/ddl_gen.go`, `internal/parser/sqlite/lexer.l`, and `internal/parser/sqlite/lexer.go` are under the SQLite license.
